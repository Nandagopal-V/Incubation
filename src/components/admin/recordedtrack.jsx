...
useEffect(()=>{
    ...
    useEffect(()=>{
        axios.post('http://localhost:4000/approvedapplicationlist').then((response)=>{   
            console.log(response.data);
...
<div className='text-center text-2xl font-bold pt-5'>Approved Application List</div>
            <div className='px-6'>
